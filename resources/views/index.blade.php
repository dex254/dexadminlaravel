        ...
        <table id="example4" class="display table" style="min-width: 845px">
            <thead>
                <tr class="bg-transparent">
                    ...
                    <th class="text-dark py-[0.85rem] px-[0.9375rem] border-b-2 border-solid border-[#E6E6E6] dark:border-[#ffffff1a] capitalize whitespace-nowrap text-base font-medium text-left">Name</th>
                    <th class="text-dark py-[0.85rem] px-[0.9375rem] border-b-2 border-solid border-[#E6E6E6] dark:border-[#ffffff1a] capitalize whitespace-nowrap text-base font-medium text-left">Email</th>
                    <th class="text-dark py-[0.85rem] px-[0.9375rem] border-b-2 border-solid border-[#E6E6E6] dark:border-[#ffffff1a] capitalize whitespace-nowrap text-base font-medium text-left">Subject/title </th>
                    <th class="text-dark py-[0.85rem] px-[0.9375rem] border-b-2 border-solid border-[#E6E6E6] dark:border-[#ffffff1a] capitalize whitespace-nowrap text-base font-medium text-left">Message</th>
                    
                </tr>
            </thead>
        @foreach($informations as $information)
        <tr class="bg-transparent">
            <td class="text-body-color bg-transparent xl:py-[0.85rem] py-2 px-[0.9375rem] capitalize whitespace-nowrap xl:text-sm text-[13px] font-normal text-left">{{ $information->name }}</td>
            <td class="text-body-color bg-transparent xl:py-[0.85rem] py-2 px-[0.9375rem] capitalize whitespace-nowrap xl:text-sm text-[13px] font-normal text-left">{{ $information->email }}</td>
            <td class="text-body-color bg-transparent xl:py-[0.85rem] py-2 px-[0.9375rem] capitalize whitespace-nowrap xl:text-sm text-[13px] font-normal text-left">{{ $information->subject }}</td>
            <td class="text-body-color bg-transparent xl:py-[0.85rem] py-2 px-[0.9375rem] capitalize whitespace-nowrap xl:text-sm text-[13px] font-normal text-left">{{ $information->message }}</td>
        </tr>
        @endforeach
    </table>
</body>
